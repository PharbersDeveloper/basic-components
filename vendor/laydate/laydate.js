...
;!function(){
  ...
  var isLayui = window.layui && layui.define, ready = {
    ...
    ,link: function(href, fn, cssname){
      ...
      link.rel = 'stylesheet';
      link.href = laydate.path + 'vendor.css'//laydate.path + href;
      link.id = id;
  ...
  ,ELEM_SELECT_START = 'layui-select-start', ELEM_SELECT_END = 'layui-select-end'
  ...
  */
  ...
  Class.prototype.stampRange = function(){
    ...
    lay.each(tds, function(i, item){
      ...
      lay(item).removeClass(ELEM_SELECTED + ' ' + THIS + ' ' + ELEM_SELECT_END + ' ' + ELEM_SELECT_START);
      if(thisTime === startTime || thisTime === endTime){
        // 对开始和结束的日子进行处理
        var thisCLass = THIS
        if (thisTime === startTime) {
          thisCLass = THIS + ' ' + ELEM_SELECT_START
        } else if (thisTime === endTime) {
          thisCLass = THIS + ' ' + ELEM_SELECT_END
        }
        lay(item).addClass(
  ...
  Class.prototype.choose = function(td){
    ...
    if(options.range){
      ...
      if(that.endState){ //重新选择
        ...
        tds.removeClass(THIS + ' ' + ELEM_SELECTED + ' ' + ELEM_SELECT_START + ' ' + ELEM_SELECT_END);
        td.addClass(THIS);
