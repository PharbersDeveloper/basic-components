...
export default Controller.extend( {
    cascaderSelected: [],
    cascaderSubSelected: computed("data", function() {
        let arr = [],
            len = this.get("data").length
    ...
    choosedValue: computed("cascaderSubSelected", function() {
            let arr = this.get("cascaderSubSelected"),
                len = [].concat(...arr).length
        if (len) {
                return "已选城市 +" + len
        } else {
                return "地区选择"
    ...
    data: ["北京市","上海市","天津市","重庆市","河北省","山西省","辽宁省","吉林省","河南省","江苏省",
        "浙江省","安徽省","福建省","江西省","山东省","湖北省","湖南省","广东省","海南省","四川省","贵州省",
        "云南省","陕西省","甘肃省","青海省","黑龙江省","内蒙古自治区","广西壮族自治区","西藏自治区","宁夏回族自治区",
